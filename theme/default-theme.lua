...
local awesome_overrides =
  ...
  theme.font = 'Poppins medium 10'
  theme.title_font = 'Poppins medium 14'
    ...
    dpi(48) ..
      ',0:0,' ..
        theme.primary.hue_500 ..
          ':0.08,' .. theme.primary.hue_500 .. ':0.08,' .. theme.background.hue_900 .. ':1,' .. theme.background.hue_900

  -- Tasklist

  theme.tasklist_font = 'Poppins medium 11'
