...
local globalKeys =
  ...
  awful.key(
    ...
    'i',
    function()
      awful.util.spawn(apps.default.emacs)
    end,
  ...
  awful.key(
    ...
    'a',
    function()
      awful.util.spawn(apps.default.atom)
    end,
  ...
  awful.key(
    ...
    'v',
    function()
      awful.util.spawn(apps.default.vivaldi)
    end,
  ...
  awful.key(
    ...
    'f',
    function()
      awful.util.spawn(apps.default.firefox)
    end,
  ...
  awful.key(
    ...
    'b',
    function()
      awful.util.spawn(apps.default.brave)
    end,
  ...
  awful.key({modkey, 'Shift'}, 'q', function() awful.spawn('/home/samy/.config/dmenu/exit.sh') end, {description = 'quit awesome', group = 'awesome'}),
  awful.key(
    {altkey, 'Shift'},
    'Right',
    function()
